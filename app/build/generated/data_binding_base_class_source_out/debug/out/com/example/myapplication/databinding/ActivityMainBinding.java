...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView,
      @NonNull FloatingActionButton addButton, @NonNull TextView notesHeading,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.notesHeading;
      TextView notesHeading = ViewBindings.findChildViewById(rootView, id);
      if (notesHeading == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, addButton, notesHeading,
          notesRecyclerView);
    }
